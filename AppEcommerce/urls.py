...
urlpatterns = [
    ...
    #path('productosListar',views.productosListar, name="productosListar"),
    #path('productosEliminar/<int:id_producto>',views.productosEliminar, name="productosEliminar"),
    #path('productosEditar/<int:id_producto>',views.productosEditar, name="productosEditar"),
    #path('productosDetalle/<int:id_producto>',views.detalle_producto, name="detalle_producto"),
    ...
    path('sliderListar',views.sliderListar, name="sliderListar"),
